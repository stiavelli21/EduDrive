...
Read this file before any task. For deeper context see:
- `architecture.md` — project structure and how to navigate the code
- `ui-style.md` — UI/UX style rules
...
- Follow existing naming conventions (see `architecture.md`).
- Follow UI style rules in `ui-style.md` for any UI work.

## After coding
- Check whether the change affects `architecture.md` or `README.md`.
  If yes, update them.
...
- `architecture.md`: kept up to date, optimized for AI navigation
