...
- `routes/`: (`auth.routes.js`, `nodes.routes.js`, `permissions.routes.js`) Endpoint HTTP e middleware di rotte (`PUT /api/auth/profile` per modifica profilo e nome visualizzato).
